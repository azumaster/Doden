...
;(function (global,factory) {
    ...
    H.share = (function() {
        function layer() {
            var str = '<div id="share_layer" style="position: fixed;left: 0; top: 0; right: 0; bottom: 0; background-color: rgba(0, 0, 0, 0.7);z-index: 9;">' +
                '<img src="'+H.localhost+'Public/images/seller-cli/share-img.png" width="100%"/></div>';
    ...
    H.defaultImg = function() {
        ...
        return {
            1: domain + 'Public/images/seller-cli/default-img.png',
            2: domain + 'Public/images/seller-cli/default-img1.png'
        };
    };
