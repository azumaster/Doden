    ...
    export default {
        ...
        data () {
            return {
                ...
                ruleValidate: {
                    type_no: [{required: true, message: '请选择兑换券类型',trigger: 'change'}],
                    title: [{ required: true, message: '请选择兑换券标题', trigger: 'blur' }, { type: 'string', trigger: 'blur' }],
                    price: [{ required: true, message: '请选择消耗钻石数量', trigger: 'blur' }],
                    worth: [{ required: true, message: '请选择兑换内容', trigger: 'blur' }],
