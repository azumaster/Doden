...
(function () {
    ...
    //获取评价管理信息
     req.getPJGL = function (obj, data, callback) {
        return send (obj, 'post', '/shop/handle/appraise/list', data, callback,  'application/json')
    }
     //获取评价详情
    req.getOrder = function (obj, data, callback) {
        return send (obj, 'get', '/shop/handle/appraise/appraise_details', data, callback, 'application/json')
    }
    //获取日志详情
    req.getLogs = function (obj, data, callback) {
        return send (obj, 'get', '/shop/handle/appraise/appraise_log', data, callback, 'application/json');
    }
