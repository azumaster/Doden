    ...
    export default {
        ...
        data: function () {
            return {
                ...
                th:[{title:'店铺名', key:'dianPuName'}, {title:'店铺类型', key:'dianpuType'}, {title: '姓名', key:'xingming'},
                    {title: '注册电话', key:'lianxiTel'}, {title: '注册时间', key: 'zhuceTime'}, {title: '店铺地址', key: 'xiangXiDiZi'},
        ...
        methods: {
            auditing: function (id) {
                window.location.href = '/html/shop-check/index.html#/closed/restart?id='+id;
                // window.location.href = '/#/closed/restart?id='+id;
            }
        },
        created () {
            this.getData();
