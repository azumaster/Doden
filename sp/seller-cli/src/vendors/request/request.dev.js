(function (window) {
  ...
  req.userPermission = (data = {}, callback) => {
    return send({type: 'get', url: 'api/shop/permission/member', data: data, callback: callback});
  };
  // 设置/取消权限
  req.editPermission = (data = {}, callback) => {
    return send({type: 'get', url: 'api/shop/permission/member/edit', data: data, callback: callback});
  };
